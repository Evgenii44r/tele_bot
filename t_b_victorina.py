...
API_TOKEN = '7782357533:AAHRnFu_7NjxVOX35XSrgHNNV85pu0XbAIU'
...
questions = {
    ...
    "Средний": [("Какая  птица не умеет летать?",'Пингвин'), ("Какую еду большие панды предпочитают любой другой?", 'Бамбук')],
